...
* `ApexOLEDStudio.Tests/`:
  * **46 модульных тестов** (100% green), тестирующих рендеринг, ватты, инверсию, сериализацию, capability validation, импорт/экспорт профилей, editor math/model и typography normalization.
...
Typography editor использует общий базовый `FontScale` (1 по умолчанию) для text,
progress, graph и gauge widgets. Команда `NORMALIZE TYPE` приводит текущий layout
к единому масштабу и минимальным согласованным высотам, сохраняя X/Y; `RESET
WIDGET` восстанавливает типографические и диапазонные defaults выбранного виджета.
Индивидуальный масштаб после нормализации можно снова изменить через Inspector.
